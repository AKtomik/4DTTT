class Settings {	
	...
	//static COLOR_BOX_EMPTY=[0,100,200,128];
	static COLOR_BOX_EMPTY=[0,128];
	static COLOR_BOX_P1_FILL=[0,128,0,128];
	static COLOR_BOX_P1_WON=[128,255,0,128];
	static COLOR_BOX_P2_FILL=[128,0,0,128];
	static COLOR_BOX_P2_WON=[255,0,0,128];
	static COLOR_BOX_P3_FILL=[0,0,128,128];
	static COLOR_BOX_P3_WON=[0,255,255,128];
